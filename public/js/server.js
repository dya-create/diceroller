...
function roll(){
    ...
    const img = document.getElementById('/views/index.html/img1');
    ...
    console.log('/public/js/server.js/img'); // displaying image of dice based on random number. dice of 1 for number 1, dice of 3 for number 3

    
    const img2 = document.getElementById('views/index.html/img2');
    ...
    console.log('/public/js/server.js/img');
